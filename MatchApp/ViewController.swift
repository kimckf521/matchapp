...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        // Check if there is any time remaining. Do not let the user interact if the time is 0
        if milliseconds <= 0 {
            return
        }
        ...
        if cell?.card?.isFlipped == false && cell?.card?.isMatched == false {
            ...
            if firstFlippedCardIndex == nil {
                ...
                // This the first card flipped over
    ...
    func checkForMatch(_ secondFlippedCardIndex:IndexPath) {
        ...
        // Get the two objects for the two indices and see if they match
    ...
    func checkForGameEnd() {
        ...
        // Check if all there is any card that is unmatched
        ...
        if hasWon == true {
            ...
            if milliseconds <= 0 {
                showAlert(title: "Time is up!", message: "Sorry, better luck next time!")
